window.onload = function () {
        ...
        var infoWindow = new google.maps.InfoWindow();
            ...
            var marker = new google.maps.Marker({
                position: myLatlng,
                map: map,
                icon: 'img/monument-historique-icon-white-22x22.png',
                title: donnees.titre
            });
            ...
            (function (marker, donnees) {
                google.maps.event.addListener(marker, "click", function (e) {
                    ...
                    infoWindow.setContent("<div style = 'width:250px;min-height:25px;font-size:1.3rem'><strong>" +donnees.titre+ "</strong><br><img src='img/img_monuments/"+donnees.photo+"'/><br><p>"+donnees.adresse+"<br></p></div>");
