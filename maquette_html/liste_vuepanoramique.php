		...
		<main>
			...
			<section class="fiche">
				...
				<article class="liste">
					...
					<div class="listeimg">
					<img src="img/img_musees/Musee_de_Montmartre.jpg"><br>
					</div>
				...
				<article class="liste">
					...
					<div class="listeimg">
					<img src="img/img_musees/aquaruim_porte_doree.jpg"><br>
					</div>
					<a href="#"><i class="fa fa-star"></i>Ajouter à vos favoris</a>
				</article>
				...
				<article class="liste">
					...
					<div class="listeimg">
					<img src="img/img_musees/Carnavalet.JPG"><br>
					</div>
					<a href="#"><i class="fa fa-star"></i>Ajouter à vos favoris</a>
				</article>
				...
				<article class="liste">
					...
					<div class="listeimg">
					<img src="img/img_musees/crypte_archeologique.JPG"><br>
					</div>
					<a href="#"><i class="fa fa-star"></i>Ajouter à vos favoris</a>
				</article>
