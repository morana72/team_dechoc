...
<?php $this->layout('layout', ['title' => 'Panoramas', 'id' => 'Passages']) ?>
...
<main>
    <section class="fiche">
        ...
        <?php foreach($passages as $key => $value) : ?>
            ...
            <article class="liste">
                ...
                <div class="listeimg">
                    <!-- image -->
                    <img src="<?= $this->assetUrl("img/passages/$value[photo]")?>" alt="<?php echo $value['photo'] ?>"/>
                </div>
    ...
    <script type="text/javascript" src="<?= $this->assetUrl("js/script_passages.js")?>"></script>
...
<script>
    ...
    function LoadMap() {
        ...
        $.ajax({
            url:'http:<?= $this->assetUrl('json/liste-passages.json') ?>',
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    (function (marker, donnees) {
                        google.maps.event.addListener(marker, "click", function (e) {
                            ...
                            infoWindow.setContent("<div style = 'width:250px;min-height:25px;font-size:1.3rem'><strong>" +donnees.titre+ "</strong><br><img src='assets/img/passages/"+donnees.photo+"'/><br><p>"+donnees.adresse+"<br></p></div>");
